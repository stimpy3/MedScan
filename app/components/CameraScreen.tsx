...
export default function CameraScreen() {
  ...
  const [ocrText, setOcrText] = useState("No text detected");
  const [editableText, setEditableText] = useState("No text detected");
  ...
  const resetCamera = () => {
    ...
    setTorch(false);
    setShowCamera(true);
    setEditableText("No text detected");
  };
      ...
      {capturedUri && (
        ...
        >
          <View style={{ 
            ...
            <View style={{ width: 40, height: 4, backgroundColor: '#ccc', alignSelf: 'center', marginBottom: 20, borderRadius: 2 }} />
            <Text style={{ fontSize: 18, fontWeight: '600', marginBottom: 16 }}>
              Detected Medicine Details
            </Text>
            ...
            <TouchableOpacity 
              ...
              onPress={() => console.log("Find Similar:", editableText)}
            >
