  ...
  return new Promise((resolve, reject) => {
    ...
    fs.createReadStream("data/medicines.csv")
      ...
      .on("data", (row) => {
        ...
        // Filtered array (for similarity search only)
        ...
        results.push({ ...record, ingredients, domains });
...
module.exports = { getSimilarMedicines, loadMedicines, normalizeIngredient, extractIngredients, getDomainsForIngredients, searchMedicineByName };